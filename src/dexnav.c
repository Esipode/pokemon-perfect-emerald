...
static void DexNavDrawIcons(void)
{
    ...
    DrawDexNavSearchMonIcon(species, &sDexNavSearchDataPtr->iconSpriteId, GetSetPokedexFlagBySpecies(species, FLAG_GET_CAUGHT));
...
static void DexNavUpdateSearchWindow(u8 proximity, u8 searchLevel)
{
    ...
    if (sDexNavSearchDataPtr->hiddenSearch && !GetSetPokedexFlagBySpecies(sDexNavSearchDataPtr->species, FLAG_GET_SEEN))
...
static u8 DexNavGetAbilityNum(enum Species species, u8 searchLevel)
{
    ...
    if (genAbility
            ...
            && GetSetPokedexFlagBySpecies(species, FLAG_GET_CAUGHT))
    {
...
static void TryDrawIconInSlot(enum Species species, s16 x, s16 y)
{
    ...
    else if (!GetSetPokedexFlagBySpecies(species, FLAG_GET_SEEN))
...
static void PrintCurrentSpeciesInfo(void)
{
    ...
    else if (GetSetPokedexFlagBySpecies(species, FLAG_GET_CAUGHT))
    {
