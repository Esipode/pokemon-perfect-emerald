...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_ATTACKMISSED_2]                       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} couldn't land the hit!"),
    [STRINGID_ATTACKMISSED_3]                       = COMPOUND_STRING("It missed completely!"),
    [STRINGID_PKMNPROTECTEDITSELF]                  = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} protected itself!"),
    [STRINGID_PKMNPROTECTEDITSELF_2]                = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} guarded itself!"),
    [STRINGID_PKMNPROTECTEDITSELF_3]                = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} protected itself from harm!"),
    ...
    [STRINGID_AVOIDEDDAMAGE_2]                      = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} avoided the damage!"),
    [STRINGID_ITDOESNTAFFECT]                       = COMPOUND_STRING("It doesn't affect {B_DEF_NAME_WITH_PREFIX2}…"),
    [STRINGID_ITDOESNTAFFECT_2]                     = COMPOUND_STRING("It won't affect {B_DEF_NAME_WITH_PREFIX2}…"),
    [STRINGID_ATTACKERFAINTED]                      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} fainted!\p"),
    [STRINGID_ATTACKERFAINTED_2]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} was knocked out!\p"),
    [STRINGID_TARGETFAINTED]                        = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} fainted!\p"),
    [STRINGID_TARGETFAINTED_2]                      = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was defeated!\p"),
    ...
    [STRINGID_PREVENTSESCAPE_2]                     = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} stops escape with {B_SCR_ACTIVE_ABILITY}!\p"),
    [STRINGID_HITXTIMES]                            = COMPOUND_STRING("The Pokémon was hit {B_BUFF1} time(s)!"), //SV has dynamic plural here
    [STRINGID_HITXTIMES_2]                          = COMPOUND_STRING("{B_BUFF1} hits landed!"),
    [STRINGID_PKMNFELLASLEEP]                       = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} fell asleep!"),
    [STRINGID_PKMNFELLASLEEP_2]                     = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX} drifted off to sleep!"),
    ...
    [STRINGID_STATSWONTINCREASE_2]                  = COMPOUND_STRING("No more of {B_ATK_NAME_WITH_PREFIX}'s {B_BUFF1} can be raised!"),
    [STRINGID_STATSWONTDECREASE]                    = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1} won't go any lower!"),
    [STRINGID_STATSWONTDECREASE_2]                  = COMPOUND_STRING("No further drop in {B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1} is possible!"),
    ...
    [STRINGID_PKMNISCONFUSED_2]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is all mixed up!"),
    [STRINGID_PKMNHEALEDCONFUSION]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} snapped out of its confusion!"),
    [STRINGID_PKMNHEALEDCONFUSION_2]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is no longer confused!"),
    ...
    [STRINGID_PKMNFELLINLOVE_2]                     = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} became lovestruck!"),
    [STRINGID_PKMNINLOVE]                           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is in love with {B_SCR_NAME_WITH_PREFIX2}!"),
    [STRINGID_PKMNINLOVE_2]                         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} has fallen for {B_SCR_NAME_WITH_PREFIX2}!"),
    [STRINGID_PKMNIMMOBILIZEDBYLOVE]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is immobilized by love!"),
    [STRINGID_PKMNIMMOBILIZEDBYLOVE_2]              = COMPOUND_STRING("Love has left {B_ATK_NAME_WITH_PREFIX} frozen in place!"),
    [STRINGID_PKMNBLOWNAWAY]                        = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was blown away!"), //unused
    [STRINGID_PKMNBLOWNAWAY_2]                      = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} was swept away!"),
    ...
    [STRINGID_PKMNFLINCHED_2]                       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} flinched!"),
    [STRINGID_PKMNREGAINEDHEALTH]                   = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s HP was restored."),
    [STRINGID_PKMNREGAINEDHEALTH_2]                 = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s HP recovered."),
    ...
    [STRINGID_PKMNHURTBY_2]                         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} took damage from {B_BUFF1}!"),
    ...
    [STRINGID_PKMNEVADEDATTACK_2]                   = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} evaded it!"),
    ...
    [STRINGID_PKMNFASTASLEEP_2]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is sound asleep."),
    [STRINGID_PKMNWOKEUP]                           = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} woke up!"),
    [STRINGID_PKMNWOKEUP_2]                         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} rose from sleep!"),
    ...
    [STRINGID_PKMNFLEDFROMBATTLE_2]                 = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} ran away from the battle!"),
    ...
    [STRINGID_PKMNTOOKATTACK_2]                     = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} absorbed the {B_BUFF1} attack!"),
    [STRINGID_PKMNATTACK]                           = COMPOUND_STRING("{B_BUFF1}'s attack!"), //not in gen 5+, expansion doesn't use anymore
    [STRINGID_PKMNATTACK_2]                         = COMPOUND_STRING("It struck with {B_BUFF1}!"),
    ...
    [STRINGID_PKMNRAISEDSPEED_2]                    = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} boosted its Speed!"),
    ...
    [STRINGID_PKMNPROTECTEDBY_2]                    = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY} protected it!"),
    ...
    [STRINGID_PKMNPREVENTSUSAGE_2]                  = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY} blocked {B_CURRENT_MOVE}!"),
    ...
    [STRINGID_STATSHARPLY_2]                        = COMPOUND_STRING("dramatically "),
    [STRINGID_STATROSE]                             = gText_StatRose,
    [STRINGID_STATROSE_2]                           = COMPOUND_STRING("rose"),
    [STRINGID_STATHARSHLY]                          = COMPOUND_STRING("harshly "),
    [STRINGID_STATHARSHLY_2]                        = COMPOUND_STRING("severely "),
    [STRINGID_STATFELL]                             = gText_StatFell,
    [STRINGID_STATFELL_2]                           = COMPOUND_STRING("fell"),
    [STRINGID_ATTACKERSSTATROSE]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_BUFF1} {B_BUFF2}"),
    [STRINGID_ATTACKERSSTATROSE_2]                  = COMPOUND_STRING("That boosted {B_ATK_NAME_WITH_PREFIX}'s {B_BUFF1}!"),
    [STRINGID_DEFENDERSSTATROSE]                    = gText_DefendersStatRose,
    [STRINGID_DEFENDERSSTATROSE_2]                  = COMPOUND_STRING("That boosted {B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1}!"),
    [STRINGID_ATTACKERSSTATFELL]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_BUFF1} {B_BUFF2}"),
    [STRINGID_ATTACKERSSTATFELL_2]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s {B_BUFF1} took a hit!"),
    [STRINGID_DEFENDERSSTATFELL]                    = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1} {B_BUFF2}"),
    [STRINGID_DEFENDERSSTATFELL_2]                  = COMPOUND_STRING("The defender's {B_BUFF1} fell sharply!"),
    [STRINGID_CRITICALHIT]                          = COMPOUND_STRING("A critical hit!"),
    [STRINGID_CRITICALHIT_2]                        = COMPOUND_STRING("Critical hit!"),
    [STRINGID_CRITICALHIT_3]                        = COMPOUND_STRING("Boom! Critical hit!"),
    [STRINGID_ONEHITKO]                             = COMPOUND_STRING("It's a one-hit KO!"),
    [STRINGID_ONEHITKO_2]                           = COMPOUND_STRING("One-hit KO!"),
    [STRINGID_ONEHITKO_3]                           = COMPOUND_STRING("It's a one-shot knock-out!"),
    ...
    [STRINGID_NOTVERYEFFECTIVE_2]                   = COMPOUND_STRING("That was barely effective…"),
    [STRINGID_NOTVERYEFFECTIVE_3]                   = COMPOUND_STRING("It hardly did anything…"),
    [STRINGID_SUPEREFFECTIVE]                       = COMPOUND_STRING("It's super effective!"),
    [STRINGID_SUPEREFFECTIVE_2]                     = COMPOUND_STRING("That's super effective!"),
    [STRINGID_SUPEREFFECTIVE_3]                     = COMPOUND_STRING("It hit with incredible force!"),
    ...
    [STRINGID_CANTESCAPE_2]                         = COMPOUND_STRING("There's no way out!\p"),
    ...
    [STRINGID_PLAYERUSEDITEM_2]                     = COMPOUND_STRING("You used one {B_LAST_ITEM}!"),
    ...
    [STRINGID_PKMNBROKEFREE_2]                      = COMPOUND_STRING("Oh no! It broke free!"),
    [STRINGID_ITAPPEAREDCAUGHT]                     = COMPOUND_STRING("Aww! It appeared to be caught!"),
    [STRINGID_ITAPPEAREDCAUGHT_2]                   = COMPOUND_STRING("Aww! It looked like it was caught!"),
    [STRINGID_AARGHALMOSTHADIT]                     = COMPOUND_STRING("Aargh! Almost had it!"),
    [STRINGID_AARGHALMOSTHADIT_2]                   = COMPOUND_STRING("So close! Almost had it!"),
    [STRINGID_SHOOTSOCLOSE]                         = COMPOUND_STRING("Gah! It was so close, too!"),
    [STRINGID_SHOOTSOCLOSE_2]                       = COMPOUND_STRING("It was so close!"),
    [STRINGID_GOTCHAPKMNCAUGHTPLAYER]               = COMPOUND_STRING("Gotcha! {B_DEF_NAME} was caught!{WAIT_SE}{PLAY_BGM MUS_CAUGHT}\p"),
    [STRINGID_GOTCHAPKMNCAUGHTPLAYER_2]             = COMPOUND_STRING("Gotcha! {B_DEF_NAME} was caught!{PLAY_BGM MUS_CAUGHT}\p"),
    ...
    [STRINGID_GIVENICKNAMECAPTURED_2]               = COMPOUND_STRING("Would you like to name {B_DEF_NAME}?"),
    ...
    [STRINGID_ITISRAINING_2]                        = COMPOUND_STRING("Rain began to fall!"),
    [STRINGID_SANDSTORMISRAGING]                    = COMPOUND_STRING("The sandstorm is raging!"),
    [STRINGID_SANDSTORMISRAGING_2]                  = COMPOUND_STRING("A sandstorm is raging!"),
    ...
    [STRINGID_ENEMYABOUTTOSWITCHPKMN_2]             = COMPOUND_STRING("The foe is sending out {B_BUFF2}.\pSwitch Pokémon?"),
