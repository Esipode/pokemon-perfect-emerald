...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_ENCMAGEARNAINTRO1]            = COMPOUND_STRING("Ancient wiring hums to life."),
    [STRINGID_ENCMAGEARNAINTRO2]            = COMPOUND_STRING("Magearna's Soul-Heart engages!"),
    [STRINGID_ENCMAGEARNAGEARWARN]          = COMPOUND_STRING("Systems reconfiguring..."),
    [STRINGID_ENCMAGEARNASACRIFICEWARN]     = COMPOUND_STRING("A system prepares to fail..."),
    [STRINGID_ENCMAGEARNADEFENSEON]         = COMPOUND_STRING("Defense systems online!"),
    [STRINGID_ENCMAGEARNAOFFENSEON]         = COMPOUND_STRING("Offense systems online!"),
    [STRINGID_ENCMAGEARNAREPAIRON]          = COMPOUND_STRING("Repair systems online!"),
    [STRINGID_ENCMAGEARNAENERGYON]          = COMPOUND_STRING("Energy systems online!"),
    [STRINGID_ENCMAGEARNADEFENSEOVERLOAD]   = COMPOUND_STRING("Defense system overloads!"),
    [STRINGID_ENCMAGEARNAOFFENSEOVERLOAD]   = COMPOUND_STRING("Offense system overloads!"),
    [STRINGID_ENCMAGEARNAREPAIROVERLOAD]    = COMPOUND_STRING("Repair system overloads!"),
    [STRINGID_ENCMAGEARNAENERGYOVERLOAD]    = COMPOUND_STRING("Energy system overloads!"),
    [STRINGID_ENCMAGEARNAUPGRADE25]         = COMPOUND_STRING("System Upgrade complete!"),
    [STRINGID_ENCMAGEARNASHIFT50]           = COMPOUND_STRING("System Shift underway..."),
    [STRINGID_ENCMAGEARNAEMERGENCY75]       = COMPOUND_STRING("Charge nearing overload!"),
    [STRINGID_ENCMAGEARNAOVERDRIVE100]      = COMPOUND_STRING("Soul-Heart at full charge!"),
    [STRINGID_ENCMAGEARNAAWAKENBEGIN]       = COMPOUND_STRING("SOUL-HEART AWAKENING!"),
    [STRINGID_ENCMAGEARNAEMERGENCYBEGIN]    = COMPOUND_STRING("EMERGENCY PROTOCOL\nengaged!"),
    [STRINGID_ENCMAGEARNASACRIFICE]         = COMPOUND_STRING("A system is sacrificed\nfor power!"),
    [STRINGID_ENCMAGEARNAPULSECHARGE]       = COMPOUND_STRING("Heart Pulse charging..."),
    [STRINGID_ENCMAGEARNAPULSEDISRUPT]      = COMPOUND_STRING("Heart Pulse disrupted!"),
    [STRINGID_ENCMAGEARNAMEGAREVERT]        = COMPOUND_STRING("Its Mega form gives out!"),
    [STRINGID_ENCMAGEARNAOVERDRIVEBEGIN]    = COMPOUND_STRING("SOUL-HEART OVERDRIVE!\nNow is the moment!{PAUSE_UNTIL_PRESS}"),
    ...
    [STRINGID_ENCGALARIANARTICUNOINTRO]             = COMPOUND_STRING("ARTICUNO FIXES YOU\nWITH A COLD STARE."),
    [STRINGID_ENCGALARIANARTICUNOFOCUSRISING]       = COMPOUND_STRING("ARTICUNO'S FOCUS\nSHARPENS!"),
    [STRINGID_ENCGALARIANARTICUNOFOCUSFADING]       = COMPOUND_STRING("ARTICUNO LOSES ITS\nCOMPOSURE."),
    [STRINGID_ENCGALARIANARTICUNOLOCKBANNER]        = COMPOUND_STRING("PSYCHIC LOCK!"),
    [STRINGID_ENCGALARIANARTICUNOLOCKMOVE]          = COMPOUND_STRING("{B_BUFF1} IS SEALED\nFROM YOUR MIND!"),
    [STRINGID_ENCGALARIANARTICUNOLOCKTRAP]          = COMPOUND_STRING("YOUR ESCAPE IS\nLOCKED AWAY!"),
    [STRINGID_ENCGALARIANARTICUNOLOCKITEM]          = COMPOUND_STRING("YOUR ITEM GOES\nCOLD AND DEAD!"),
    [STRINGID_ENCGALARIANARTICUNOLOCKSTATS]         = COMPOUND_STRING("YOUR RESOLVE\nWAVERS!"),
    [STRINGID_ENCGALARIANARTICUNOPREDICTHIT]        = COMPOUND_STRING("ARTICUNO HAS READ\nYOUR MIND!"),
    [STRINGID_ENCGALARIANARTICUNOPREDICTMISS]       = COMPOUND_STRING("ITS PREDICTION\nFALTERS!"),
    [STRINGID_ENCGALARIANARTICUNOMINDGAMESASK]      = COMPOUND_STRING("RESIST ITS PRESSURE,\nOR YIELD TO IT?"),
    [STRINGID_ENCGALARIANARTICUNOMINDGAMESRESIST]   = COMPOUND_STRING("YOU STEEL YOUR\nNERVE."),
    [STRINGID_ENCGALARIANARTICUNOMINDGAMESYIELD]    = COMPOUND_STRING("ARTICUNO SEIZES\nTHE OPENING."),
    ...
    [STRINGID_ENCGALARIANZAPDOSVICIOUSBLOW]        = COMPOUND_STRING("Zapdos capitalizes on\nthe opening!"),
    [STRINGID_ENCGALARIANZAPDOSMOMENTUMSURGE]      = COMPOUND_STRING("Zapdos surges with\nmomentum!"),
    [STRINGID_ENCGALARIANZAPDOSSTAGGERED]          = COMPOUND_STRING("Zapdos has been\nstaggered!"),
    [STRINGID_ENCGALARIANZAPDOSOVEREXTENDS]        = COMPOUND_STRING("Zapdos overextends\nits attack!"),
    [STRINGID_ENCGALARIANZAPDOSTHROWNOFF]          = COMPOUND_STRING("The status throws\nZapdos off rhythm!"),
    [STRINGID_ENCGALARIANZAPDOSCOMBOCONTINUES]     = COMPOUND_STRING("Zapdos keeps up the\nassault!"),
    [STRINGID_ENCGALARIANZAPDOSGIVESCHASE]         = COMPOUND_STRING("Zapdos gives chase!"),
    [STRINGID_ENCGALARIANZAPDOSPURSUITCOUNTERED]   = COMPOUND_STRING("The ground grounds\nthe pursuit!"),
    [STRINGID_ENCGALARIANZAPDOSRELENTLESSASSAULT]  = COMPOUND_STRING("RELENTLESS ASSAULT!"),
    [STRINGID_ENCGALARIANZAPDOSFRENZY]             = COMPOUND_STRING("Galarian Zapdos throws\nitself into a frenzy!"),
    [STRINGID_ENCGALARIANZAPDOSREFUSESTOSTOP]      = COMPOUND_STRING("Zapdos refuses to\nstop! Now's the moment!"),
    [STRINGID_ENCGALARIANZAPDOSWEAKNESSHIT]        = COMPOUND_STRING("The hit rattles\nZapdos's focus!"),

    [STRINGID_ENCGALARIANMOLTRESDARKHIT]           = COMPOUND_STRING("A shiver runs down\nyour spine!"),
    [STRINGID_ENCGALARIANMOLTRESCHIPHIT]           = COMPOUND_STRING("Dread creeps a\nlittle deeper."),
    [STRINGID_ENCGALARIANMOLTRESFAINTFEED]         = COMPOUND_STRING("Moltres feeds on\nyour fallen Pokemon!"),
    [STRINGID_ENCGALARIANMOLTRESSTEELSNERVE]       = COMPOUND_STRING("Your Pokemon steels\nits nerve."),
    [STRINGID_ENCGALARIANMOLTRESNEWCOMERWATCHED]   = COMPOUND_STRING("The newcomer feels\nsomething watching..."),
    [STRINGID_ENCGALARIANMOLTRESSTATUSDREAD]       = COMPOUND_STRING("Their fear curdles\nwith the sickness."),
    [STRINGID_ENCGALARIANMOLTRESCOURAGEHIT]        = COMPOUND_STRING("Moltres flinches -\nthat hurt its pride!"),
    [STRINGID_ENCGALARIANMOLTRESLIFEDRAIN2]        = COMPOUND_STRING("Moltres feeds on\nyour fear!"),
    [STRINGID_ENCGALARIANMOLTRESLIFEDRAIN3]        = COMPOUND_STRING("Moltres feasts on\nyour fear!"),
    [STRINGID_ENCGALARIANMOLTRESLIFEDRAIN4]        = COMPOUND_STRING("Moltres gorges on\nyour fear!"),
    [STRINGID_ENCGALARIANMOLTRESLIFEDRAIN5]        = COMPOUND_STRING("The DARK AURA feeds\non your fear!"),
    [STRINGID_ENCGALARIANMOLTRESNIGHTMAREMARK]     = COMPOUND_STRING("A Nightmare settles\nover your Pokemon!"),
    [STRINGID_ENCGALARIANMOLTRESNIGHTMAREGNAW]     = COMPOUND_STRING("The Nightmare\ngnaws at them."),
    [STRINGID_ENCGALARIANMOLTRESNIGHTMAREFADE]     = COMPOUND_STRING("The Nightmare\nfades away."),
    [STRINGID_ENCGALARIANMOLTRESPHASE2]            = COMPOUND_STRING("The darkness around\nMoltres deepens..."),
    [STRINGID_ENCGALARIANMOLTRESPHASE3]            = COMPOUND_STRING("Moltres unleashes\nits full power!"),
    [STRINGID_ENCGALARIANMOLTRESBALLSUNLOCK]       = COMPOUND_STRING("Now is the moment\nto strike!"),
    ...
    [STRINGID_ENCZARUDESTIRSINTHETREES]            = COMPOUND_STRING("Something is watching\nfrom the trees..."),
    [STRINGID_ENCZARUDETERRITORYRISES]             = COMPOUND_STRING("The jungle presses in\naround you!"),
    [STRINGID_ENCZARUDEOVERGROWN]                  = COMPOUND_STRING("Vines creep across the\nfield. OVERGROWN."),
    [STRINGID_ENCZARUDEJUNGLE]                     = COMPOUND_STRING("The battlefield has become\na JUNGLE."),
    [STRINGID_ENCZARUDEDEEPJUNGLE]                 = COMPOUND_STRING("DEEP JUNGLE swallows\nthe battlefield!"),
    [STRINGID_ENCZARUDEANCIENTJUNGLE]              = COMPOUND_STRING("ANCIENT JUNGLE roots\ntake hold!"),
    [STRINGID_ENCZARUDEVINESWRAP]                  = COMPOUND_STRING("VINES WRAP AROUND\nyour Pokémon!"),
    [STRINGID_ENCZARUDEVINESWITHER]                = COMPOUND_STRING("The vines wither away,\nfeeding the jungle."),
    [STRINGID_ENCZARUDEAMBUSHTELEGRAPH]            = COMPOUND_STRING("Something moves through\nthe jungle..."),
    [STRINGID_ENCZARUDEAMBUSHANTICIPATED]          = COMPOUND_STRING("AMBUSH ANTICIPATED!\nZarude's cover is blown!"),
    [STRINGID_ENCZARUDEAMBUSHSTRIKES]              = COMPOUND_STRING("JUNGLE AMBUSH!\nZarude strikes from hiding!"),
    [STRINGID_ENCZARUDECHESTBEAT]                  = COMPOUND_STRING("Zarude beats its chest!\nDEEP JUNGLE forms!"),
    [STRINGID_ENCZARUDEBARRIERBREAK]               = COMPOUND_STRING("The vine ward\nshatters!"),
    [STRINGID_ENCZARUDETROOPRALLIES]               = COMPOUND_STRING("The troop rallies\naround its leader!"),
    [STRINGID_ENCZARUDEJUNGLEFURY]                 = COMPOUND_STRING("JUNGLE FURY grips\nZarude!"),
    [STRINGID_ENCZARUDENOWISTHEMOMENT]             = COMPOUND_STRING("Zarude's guard is down -\nnow is the moment!"),
    [STRINGID_ENCZARUDEJUNGLEFEEDS]                = COMPOUND_STRING("THE JUNGLE FEEDS\nZARUDE!"),
    ...
    [STRINGID_ENCZACIANSTANCESWIFT]                = COMPOUND_STRING("Zacian shifts to SWIFT\nstance! It's after speed!"),
    [STRINGID_ENCZACIANSTANCEPOWER]                = COMPOUND_STRING("Zacian shifts to POWER\nstance! Brace for impact!"),
    [STRINGID_ENCZACIANSTANCEPRECISION]            = COMPOUND_STRING("Zacian shifts to\nPRECISION stance!"),
    [STRINGID_ENCZACIANSTANCEEXECUTION]            = COMPOUND_STRING("Zacian shifts to\nEXECUTION stance!"),
    [STRINGID_ENCZACIANMARKOFSWORD]                = COMPOUND_STRING("{B_BUFF1} bears the MARK\nOF THE SWORD!"),
    [STRINGID_ENCZACIANPERFECTWARNING]             = COMPOUND_STRING("Zacian's next strike will\nbe unstoppable!"),
    [STRINGID_ENCZACIANPERFECTSTRIKE]              = COMPOUND_STRING("PERFECT STRIKE!"),
    [STRINGID_ENCZACIANANTICIPATED]                = COMPOUND_STRING("ZACIAN ANTICIPATED YOUR\nMOVE!"),
    [STRINGID_ENCZACIANCROWNEDSWORD]               = COMPOUND_STRING("Zacian draws the CROWNED\nSWORD!"),
    [STRINGID_ENCZACIANRISINGSLASH]                = COMPOUND_STRING("Rising Slash!"),
    [STRINGID_ENCZACIANCROSSSLASH]                 = COMPOUND_STRING("Cross Slash!"),
    [STRINGID_ENCZACIANMETEORSLASH]                = COMPOUND_STRING("Zacian gathers light for\nMeteor Slash!"),
    [STRINGID_ENCZACIANROYALCUT]                   = COMPOUND_STRING("Royal Cut shears your\nguard away!"),
    [STRINGID_ENCZACIANMASTERSWORDSMAN]            = COMPOUND_STRING("Zacian becomes the MASTER\nSWORDSMAN!"),
    [STRINGID_ENCZACIANBEHEMOTHBLADE]              = COMPOUND_STRING("Zacian raises the sacred\nBEHEMOTH BLADE!"),
    ...
    [STRINGID_ENCWOCHIENINTRO1]                    = COMPOUND_STRING("Wo-Chien crouches over\nrotting roots."),
    [STRINGID_ENCWOCHIENINTRO2]                    = COMPOUND_STRING("The RUINOUS TABLET drains\nlife from everything near."),
    [STRINGID_ENCWOCHIENFIELDWITHERS]              = COMPOUND_STRING("The battlefield begins\nto wither!"),
    [STRINGID_ENCWOCHIENFIELDROTS]                 = COMPOUND_STRING("Rot spreads across\nthe field!"),
    [STRINGID_ENCWOCHIENFIELDDIES]                 = COMPOUND_STRING("The field is dead\nand lifeless."),
    [STRINGID_ENCWOCHIENHEALBLOCKED]               = COMPOUND_STRING("Rot chokes off any\nhealing here!"),
    [STRINGID_ENCWOCHIENVINESWRAP]                 = COMPOUND_STRING("Ruinous vines coil\naround your Pokémon!"),
    [STRINGID_ENCWOCHIENVINESDRAIN]                = COMPOUND_STRING("The vines drain your\nPokémon's strength!"),
    [STRINGID_ENCWOCHIENVINESBREAK]                = COMPOUND_STRING("The vines are torn away!\nSpores burst outward!"),
    [STRINGID_ENCWOCHIENRUINMARK]                  = COMPOUND_STRING("A curse mark settles\non your Pokémon!"),
    [STRINGID_ENCWOCHIENRUINMARKSTING]             = COMPOUND_STRING("The curse mark burns\ndeep!"),
    [STRINGID_ENCWOCHIENRUINMARKFAINT]             = COMPOUND_STRING("The curse mark tears\nfree - the rot deepens!"),
    [STRINGID_ENCWOCHIENFOREST]                    = COMPOUND_STRING("Wo-Chien sinks deeper\ninto the rot."),
    [STRINGID_ENCWOCHIENSELFHEAL]                  = COMPOUND_STRING("Wo-Chien draws strength\nfrom the rotting field."),
    [STRINGID_ENCWOCHIENCHANNELSTART]              = COMPOUND_STRING("Wo-Chien begins a long,\ndraining channel!"),
    [STRINGID_ENCWOCHIENCHANNELINTERRUPT]          = COMPOUND_STRING("The draining channel\nis shattered!"),
    [STRINGID_ENCWOCHIENCHANNELDRAIN]              = COMPOUND_STRING("RUINOUS DRAIN completes!\nWo-Chien is restored!"),
    ...
    [STRINGID_ENCMUNKIDORIINTRO]                     = COMPOUND_STRING("Munkidori tilts its head,\nreading you already."),
    [STRINGID_ENCMUNKIDORIPREDICTIONHIT]             = COMPOUND_STRING("MUNKIDORI SAW THAT\nCOMING!"),
    [STRINGID_ENCMUNKIDORIPREDICTIONMISS]            = COMPOUND_STRING("It guessed wrong -\nits read slips!"),
    [STRINGID_ENCMUNKIDORITOXICTHOUGHTAPPLIED]       = COMPOUND_STRING("A TOXIC THOUGHT creeps\ninto your mind!"),
    [STRINGID_ENCMUNKIDORITOXICTHOUGHTTURN1]         = COMPOUND_STRING("The thought clouds your\njudgment - stats drop!"),
    [STRINGID_ENCMUNKIDORITOXICTHOUGHTTICK]          = COMPOUND_STRING("The TOXIC THOUGHT\nlingers on."),
    [STRINGID_ENCMUNKIDORITOXICTHOUGHTTURN4]         = COMPOUND_STRING("The thought fades -\nyour focus returns!"),
    [STRINGID_ENCMUNKIDORIBLUFFREAL]                 = COMPOUND_STRING("Munkidori's eyes narrow -\nthis one is real."),
    [STRINGID_ENCMUNKIDORIBLUFFFAKE]                 = COMPOUND_STRING("Munkidori's eyes flicker -\na bluff, maybe."),
    [STRINGID_ENCMUNKIDORIBLUFFFELLFOR]              = COMPOUND_STRING("You braced for nothing -\nit reads you deeper!"),
    [STRINGID_ENCMUNKIDORIBLUFFREADPAST]             = COMPOUND_STRING("You saw through the\nbluff completely!"),
    [STRINGID_ENCMUNKIDORIPSYCHICCONTROL]            = COMPOUND_STRING("PSYCHIC CONTROL!\nMunkidori seizes the mind!"),
    [STRINGID_ENCMUNKIDORIHIJACKWARN]                = COMPOUND_STRING("Munkidori locks onto\nyour next move type!"),
    [STRINGID_ENCMUNKIDORIHIJACKPUNISH]              = COMPOUND_STRING("The move bends back -\nHIJACKED!"),
    [STRINGID_ENCMUNKIDORIOVERCONFIDENTENTER]        = COMPOUND_STRING("OVERCONFIDENT!\nIts guard drops!"),
    [STRINGID_ENCMUNKIDORIOVERCONFIDENTEXIT]         = COMPOUND_STRING("Munkidori refocuses -\nits guard returns."),
    [STRINGID_ENCMUNKIDORIMINDBREAK]                 = COMPOUND_STRING("MIND BREAK!\nIts control frays wildly!"),
    ...
    [STRINGID_ENCMIRAIDONNETWORKONLINE]              = COMPOUND_STRING("Miraidon's Analysis\nNetwork comes online!"),
    [STRINGID_ENCMIRAIDONCALCULATING]                = COMPOUND_STRING("Miraidon is\nCALCULATING!"),
    [STRINGID_ENCMIRAIDONIDLE]                       = COMPOUND_STRING("Miraidon's systems\nidle for now."),
    [STRINGID_ENCMIRAIDONANALYSISRISE]               = COMPOUND_STRING("Resisted! The Analysis\nNetwork expands."),
    [STRINGID_ENCMIRAIDONCALCCONFIRMED]              = COMPOUND_STRING("CALCULATION\nCONFIRMED!"),
    [STRINGID_ENCMIRAIDONMISCALCULATION]             = COMPOUND_STRING("MISCALCULATION!\nAnalysis disrupted."),
    [STRINGID_ENCMIRAIDONREPEATREAD]                 = COMPOUND_STRING("Pattern logged.\nAnalysis deepens."),
    [STRINGID_ENCMIRAIDONNODEOFFLINE]                = COMPOUND_STRING("A Node goes\noffline!"),
    [STRINGID_ENCMIRAIDONSCANCOMPLETE]               = COMPOUND_STRING("SCAN complete!\nWeakness exploited."),
    [STRINGID_ENCMIRAIDONSCANFADES]                  = COMPOUND_STRING("The scan fades."),
    [STRINGID_ENCMIRAIDONFUTUREENGINE]               = COMPOUND_STRING("FUTURE ENGINE\nonline!"),
    [STRINGID_ENCMIRAIDONOVERCLOCK]                  = COMPOUND_STRING("OVERCLOCK\nengaged!"),
    [STRINGID_ENCMIRAIDONOVERCLOCKTICK]              = COMPOUND_STRING("Systems running\nhot."),
    [STRINGID_ENCMIRAIDONSYSTEMSOFFLINE]             = COMPOUND_STRING("Systems offline."),
    [STRINGID_ENCMIRAIDONPARADOXCOLLAPSE]            = COMPOUND_STRING("PARADOX COLLAPSE\nbegins!"),
    [STRINGID_ENCMIRAIDONERROR]                      = COMPOUND_STRING("ERROR! Safeties\ndisengaged!"),
