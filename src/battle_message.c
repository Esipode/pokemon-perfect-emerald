...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_ENCARCEUSSILENCE]             = COMPOUND_STRING("The world falls completely silent.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCARCEUSAUTHORITYZERO]       = COMPOUND_STRING("Arceus's presence thins.\pThe air is only air."),
    [STRINGID_ENCARCEUSAUTHORITYONE]        = COMPOUND_STRING("Arceus's will settles over the field."),
    ...
    [STRINGID_ENCARCEUSAUTHORITYWAVERS]     = COMPOUND_STRING("Arceus reaches for something, and finds nothing there.\pIts authority wavers."),
    [STRINGID_ENCARCEUSPLATESAWAKEN]        = COMPOUND_STRING("Arceus's ring begins to glow.\pThe Plates surrounding its body resonate.\pTHE PLATES AWAKEN.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCARCEUSPLATETURNS]          = COMPOUND_STRING("Arceus's ring turns."),
    [STRINGID_ENCARCEUSNEXTFLAME]           = COMPOUND_STRING("The FLAME PLATE rises to the fore."),
    [STRINGID_ENCARCEUSNEXTSPLASH]          = COMPOUND_STRING("The SPLASH PLATE rises to the fore."),
    [STRINGID_ENCARCEUSNEXTZAP]             = COMPOUND_STRING("The ZAP PLATE rises to the fore."),
    [STRINGID_ENCARCEUSNEXTMEADOW]          = COMPOUND_STRING("The MEADOW PLATE rises to the fore."),
    [STRINGID_ENCARCEUSNEXTICICLE]          = COMPOUND_STRING("The ICICLE PLATE rises to the fore."),
    [STRINGID_ENCARCEUSNEXTFIST]            = COMPOUND_STRING("The FIST PLATE rises to the fore."),
    [STRINGID_ENCARCEUSLAWFLAME]            = COMPOUND_STRING("THE LAW OF FLAME.\pArceus decrees that the world shall burn.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCARCEUSLAWWATER]            = COMPOUND_STRING("THE LAW OF WATER.\pArceus decrees that the world shall drown.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCARCEUSLAWLIGHTNING]        = COMPOUND_STRING("THE LAW OF LIGHTNING.\pArceus decrees that nothing shall outrun it.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCARCEUSLAWLIFE]             = COMPOUND_STRING("THE LAW OF LIFE.\pArceus decrees that the world shall take what it needs.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCARCEUSLAWFROST]            = COMPOUND_STRING("THE LAW OF FROST.\pArceus decrees that all things shall be stilled.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCARCEUSLAWFORCE]            = COMPOUND_STRING("THE LAW OF FORCE.\pArceus decrees that strength shall answer to nothing.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCARCEUSLAWHOLDS]            = COMPOUND_STRING("Arceus's law still holds over the field."),
    ...
    [STRINGID_ENCARCEUSDECREEBINDING]       = COMPOUND_STRING("ARCEUS HAS DECLARED A DECREE.\pNone may leave the Creator's presence.{PAUSE_UNTIL_PRESS}"),
    ...
    [STRINGID_ENCARCEUSHOLDSSTRENGTH]       = COMPOUND_STRING("The Decree of Strength still holds."),
    [STRINGID_ENCARCEUSHOLDSMIND]           = COMPOUND_STRING("The Decree of Mind still holds."),
    [STRINGID_ENCARCEUSHOLDSBINDING]        = COMPOUND_STRING("The Decree of Binding still holds."),
    [STRINGID_ENCARCEUSHOLDSBALANCE]        = COMPOUND_STRING("The Decree of Balance still holds."),
    [STRINGID_ENCARCEUSHOLDSTOLL]           = COMPOUND_STRING("The Decree of Toll still holds."),
    [STRINGID_ENCARCEUSDECREEENDS]          = COMPOUND_STRING("Arceus lets the Decree fall away."),
    [STRINGID_ENCARCEUSDECREECRACKS]        = COMPOUND_STRING("The Decree cracks under the pressure!{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCARCEUSDECIDESTOJUDGE]      = COMPOUND_STRING("Arceus raises its head.\pThe Plates begin to orbit faster.\pARCEUS HAS DECIDED TO JUDGE YOU.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCARCEUSRECALLSCREATION]     = COMPOUND_STRING("ARCEUS RECALLS THE POWERS OF CREATION.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCARCEUSJUDGES]              = COMPOUND_STRING("ARCEUS HAS PASSED JUDGMENT ON YOUR POKéMON.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCARCEUSMARKED]              = COMPOUND_STRING("Arceus's gaze has not left your POKéMON."),
    [STRINGID_ENCARCEUSCONDEMNED]           = COMPOUND_STRING("Arceus's attacks begin to converge.\pJUDGMENT NEARS.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCARCEUSMARKTRANSFERS]       = COMPOUND_STRING("The Judgment settles onto the POKéMON that took the field."),
    ...
    [STRINGID_ENCARCEUSSEENENOUGH]          = COMPOUND_STRING("ARCEUS HAS SEEN ENOUGH.\pIt shapes itself against what you have shown it.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCARCEUSPLATESSHATTER]       = COMPOUND_STRING("Arceus's body begins to radiate an impossible light.\pTHE PLATES SHATTER.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCARCEUSORIGINALONE]         = COMPOUND_STRING("THE ORIGINAL ONE.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCARCEUSPREPARESJUDGMENT]    = COMPOUND_STRING("ARCEUS PREPARES TO PASS JUDGMENT UPON THE WORLD.{PAUSE_UNTIL_PRESS}"),
    ...
    [STRINGID_ENCARCEUSABSOLUTE]            = COMPOUND_STRING("Arceus's authority is absolute.\pThere is nothing to do but endure.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCARCEUSCHARGEDEEPENS]       = COMPOUND_STRING("The gathering light deepens."),
    [STRINGID_ENCARCEUSLADDEREIGHTEEN]      = COMPOUND_STRING("Eighteen Plates orbit the gathering light."),
    [STRINGID_ENCARCEUSLADDERTWELVE]        = COMPOUND_STRING("Twelve Plates orbit the gathering light."),
    [STRINGID_ENCARCEUSLADDEREIGHT]         = COMPOUND_STRING("Eight Plates orbit the gathering light."),
    [STRINGID_ENCARCEUSLADDERFOUR]          = COMPOUND_STRING("Four Plates orbit the gathering light."),
    [STRINGID_ENCARCEUSLADDERONE]           = COMPOUND_STRING("One Plate orbits the gathering light."),
    ...
    [STRINGID_ENCARCEUSREELS]               = COMPOUND_STRING("Arceus reels, and the light comes apart in its hands.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCARCEUSJUDGMENTCREATION]    = COMPOUND_STRING("JUDGMENT: CREATION.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCARCEUSFINALMOMENT]         = COMPOUND_STRING("Arceus stands silently.\pThe last blow is yours to strike.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCARCEUSNOTSTILLED]          = COMPOUND_STRING("The Original One does not sleep, and is not stilled.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCARCEUSWEAKENED]            = COMPOUND_STRING("The light around Arceus fades to almost nothing.\pIt's weakened - now is the moment to catch it!{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCAZELFAWAKENS]      = COMPOUND_STRING("Azelf's eyes snap open.\pIt does not flee. It does not hesitate.\pIt comes straight for you.{PAUSE_UNTIL_PRESS}"),
    ...
    [STRINGID_ENCAZELFSHRUGS]       = COMPOUND_STRING("Azelf throws the affliction off!\pIts will does not waver - it only sharpens."),
    ...
    [STRINGID_ENCAZELFUNMATCHED]    = COMPOUND_STRING("AZELF IS UNMATCHED.\pIt moves before you finish deciding."),
    [STRINGID_ENCAZELFUNBREAKABLE]  = COMPOUND_STRING("AZELF'S WILL IS UNBREAKABLE.\pEverything you do to it, it returns.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCAZELFBURNS]        = COMPOUND_STRING("Azelf's will still burns white-hot."),
    [STRINGID_ENCAZELFNARROWS]      = COMPOUND_STRING("Azelf's eyes narrow.\pIt is only getting started."),
    [STRINGID_ENCAZELFRESOLUTE]     = COMPOUND_STRING("AZELF IS RESOLUTE.\pHalf measures will not reach it now.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCAZELFREFUSES]      = COMPOUND_STRING("AZELF REFUSES TO FALL!{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCAZELFFLOODSBACK]   = COMPOUND_STRING("Its will floods back, brighter than before."),
    [STRINGID_ENCAZELFHOLLOW]       = COMPOUND_STRING("Azelf reaches for its will - and finds nothing there.\pIt has spent everything it had.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCAZELFLASTSTAND]    = COMPOUND_STRING("Azelf plants itself between you and the way out.\pLAST STAND.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCAZELFHOLDS]        = COMPOUND_STRING("Azelf will not fall while it still has a will to fight!"),
    [STRINGID_ENCAZELFLASH]         = COMPOUND_STRING("Azelf's will lashes back!"),
    [STRINGID_ENCAZELFBREAKS]       = COMPOUND_STRING("Azelf's will finally breaks.\pIts body slumps. Whatever was holding it up is gone.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCAZELFWEAKENED]     = COMPOUND_STRING("Azelf's eyes dim, and it settles to the ground.\pIt's worn out - now is the moment to catch it!{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCUXIEAWAKENS]          = COMPOUND_STRING("Uxie opens its eyes.\pIt does not look at your POKéMON.\pIt looks at you.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCUXIEREADPHYS]         = COMPOUND_STRING("Uxie foresees a blow struck with force."),
    [STRINGID_ENCUXIEREADSPEC]         = COMPOUND_STRING("Uxie foresees a blow struck with will."),
    [STRINGID_ENCUXIEREADSTAT]         = COMPOUND_STRING("Uxie foresees that you will not strike at all."),
    ...
    [STRINGID_ENCUXIEFORESEENSTAT]     = COMPOUND_STRING("Uxie foresaw even your hesitation."),
    [STRINGID_ENCUXIEDEFIED]           = COMPOUND_STRING("Uxie's prediction was wrong!"),
    [STRINGID_ENCUXIEFILED]            = COMPOUND_STRING("Uxie files away the shape of {B_BUFF1}.\pIt will not be caught by that again."),
    [STRINGID_ENCUXIEHARDENED]         = COMPOUND_STRING("Uxie already knows {B_BUFF1}.\pIts understanding of it deepens."),
    [STRINGID_ENCUXIEEVICTED]          = COMPOUND_STRING("Uxie sets aside what it knew of {B_BUFF2} to make room for {B_BUFF1}."),
    [STRINGID_ENCUXIEFORGETS]          = COMPOUND_STRING("Uxie loses its grasp on {B_BUFF1}!"),
    [STRINGID_ENCUXIEUNSEEN]           = COMPOUND_STRING("Uxie has never seen this from you!"),
    [STRINGID_ENCUXIETESTPHYS]         = COMPOUND_STRING("Uxie challenges your knowledge!\pIt foresees a blow struck with force.\pWill you prove it right?"),
    [STRINGID_ENCUXIETESTSPEC]         = COMPOUND_STRING("Uxie challenges your knowledge!\pIt foresees a blow struck with will.\pWill you prove it right?"),
    [STRINGID_ENCUXIETESTSTAT]         = COMPOUND_STRING("Uxie challenges your knowledge!\pIt foresees that you will not strike at all.\pWill you prove it right?"),
    ...
    [STRINGID_ENCUXIEVOWBROKEN]        = COMPOUND_STRING("Uxie cannot reconcile your words with your actions!"),
    [STRINGID_ENCUXIEBACKLASH]         = COMPOUND_STRING("The contradiction reels through your POKéMON's mind!"),
    [STRINGID_ENCUXIEK0]               = COMPOUND_STRING("Uxie is reconsidering what it knows."),
    [STRINGID_ENCUXIEK1]               = COMPOUND_STRING("Uxie is beginning to understand you."),
    [STRINGID_ENCUXIEK2]               = COMPOUND_STRING("Uxie has grasped the shape of your fighting."),
    [STRINGID_ENCUXIEK3]               = COMPOUND_STRING("Uxie anticipates you now."),
    [STRINGID_ENCUXIEK4]               = COMPOUND_STRING("Uxie knows your intentions before you form them."),
    [STRINGID_ENCUXIEK5]               = COMPOUND_STRING("OMNISCIENCE.\pUxie knows everything.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCUXIEUNDERSTANDING]    = COMPOUND_STRING("Uxie has learned almost everything about you.\pIt is no longer studying. It is confirming.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCUXIEOMNISCIENCE]      = COMPOUND_STRING("Uxie closes its eyes.\pIt no longer needs to watch you to know what you will do.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCUXIEWEAKENED]         = COMPOUND_STRING("Uxie's eyes lose their focus, and it sinks toward the ground.\pIt's weakened - now is the moment to catch it!{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCUXIEREELING]          = COMPOUND_STRING("Uxie is still reeling. It is not reading you."),
    [STRINGID_ENCUXIECANNOTCOMPREHEND] = COMPOUND_STRING("Uxie cannot comprehend what just happened!\pEverything it had gathered comes apart at once.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCUXIEREFORMS]          = COMPOUND_STRING("Uxie gathers itself.\pIt knows you again.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCUXIEREFUSESSLEEP]     = COMPOUND_STRING("Uxie's mind cannot be dimmed.\pIt has already learned from the attempt."),
    [STRINGID_ENCUXIEENLIGHTENED]      = COMPOUND_STRING("Your loss has taught it something."),

    [STRINGID_ENCMESPRITAWAKENS]        = COMPOUND_STRING("Mesprit's eyes open, and they are already searching yours.\pIt does not know yet what it will feel about you.{PAUSE_UNTIL_PRESS}"),
    ...
    [STRINGID_ENCMESPRITSADNESS]        = COMPOUND_STRING("Mesprit's gaze falls away from yours.\pSADNESS."),
    [STRINGID_ENCMESPRITOVERJOYED]      = COMPOUND_STRING("Its delight has nowhere left to go.\pOVERJOYED."),
    [STRINGID_ENCMESPRITRAGE]           = COMPOUND_STRING("It has stopped protecting itself entirely.\pRAGE."),
    [STRINGID_ENCMESPRITPANIC]          = COMPOUND_STRING("It will not let anything reach it now.\pPANIC."),
    [STRINGID_ENCMESPRITDESPAIR]        = COMPOUND_STRING("Something in it has quietly given up.\pDESPAIR."),
    [STRINGID_ENCMESPRITOVERWHELMING]   = COMPOUND_STRING("MESPRIT'S EMOTIONS BECOME OVERWHELMING!{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCMESPRITSTIRS]          = COMPOUND_STRING("Mesprit has watched you long enough.\pSomething stirs in it."),
    [STRINGID_ENCMESPRITCALMHOLDS]      = COMPOUND_STRING("Mesprit is still waiting for you to do something."),
    [STRINGID_ENCMESPRITJOYHOLDS]       = COMPOUND_STRING("Mesprit is still delighted with you."),
    [STRINGID_ENCMESPRITANGERHOLDS]     = COMPOUND_STRING("Mesprit's anger has not cooled."),
    [STRINGID_ENCMESPRITFEARHOLDS]      = COMPOUND_STRING("Mesprit is still braced against you."),
    [STRINGID_ENCMESPRITSADNESSHOLDS]   = COMPOUND_STRING("Mesprit's sorrow has not lifted."),
    [STRINGID_ENCMESPRITTHRIVES]        = COMPOUND_STRING("Mesprit's joy spills over, and its hurts close up."),
    [STRINGID_ENCMESPRITLASHES]         = COMPOUND_STRING("Mesprit's fury lashes out at your POKéMON!"),
    [STRINGID_ENCMESPRITCOWERS]         = COMPOUND_STRING("Mesprit cannot stop flinching."),
    [STRINGID_ENCMESPRITHIDES]          = COMPOUND_STRING("Mesprit hides behind its own terror!"),
    [STRINGID_ENCMESPRITDRAINS]         = COMPOUND_STRING("Mesprit's sorrow pulls at your POKéMON!"),
    [STRINGID_ENCMESPRITWASHESOVER]     = COMPOUND_STRING("Mesprit's emotions wash over your POKéMON!"),
    [STRINGID_ENCMESPRITCONTJOY]        = COMPOUND_STRING("It is swept up in the delight."),
    [STRINGID_ENCMESPRITCONTANGER]      = COMPOUND_STRING("It burns to strike, and sees less for it."),
    ...
    [STRINGID_ENCMESPRITCONTFADES]      = COMPOUND_STRING("The borrowed feeling drains out of your POKéMON."),
    [STRINGID_ENCMESPRITSHIFTSOFF]      = COMPOUND_STRING("Mesprit's mood shifts, and the affliction slips away."),
    [STRINGID_ENCMESPRITSORROWCLEARS]   = COMPOUND_STRING("Mesprit's sorrow washes everything else away."),
    [STRINGID_ENCMESPRITUNSTABLE]       = COMPOUND_STRING("Mesprit can no longer hold onto a feeling.\pIts moods begin to turn on a single moment.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCMESPRITEMPATHY]        = COMPOUND_STRING("Mesprit reaches into your POKéMON's heart.\pIt has stopped reacting to you.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCMESPRITEMPATHYANGER]   = COMPOUND_STRING("It has been carrying your fury this whole time.\pNow it gives it back."),
    [STRINGID_ENCMESPRITEMPATHYFEAR]    = COMPOUND_STRING("It has been carrying your caution this whole time.\pNow it hides behind it."),
    [STRINGID_ENCMESPRITEMPATHYSADNESS] = COMPOUND_STRING("It has been carrying your doubt this whole time.\pNow it has nothing else left."),
    [STRINGID_ENCMESPRITWEAKENED]       = COMPOUND_STRING("Mesprit's eyes go quiet, and it drifts down to you.\pIt's worn out - now is the moment to catch it!{PAUSE_UNTIL_PRESS}"),

    [STRINGID_ENCREGIGIGASSLUMBERS]        = COMPOUND_STRING("A colossus fills the chamber, and it does not look at you.\pRegigigas is asleep.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCREGIGIGASRUNG0]           = COMPOUND_STRING("Regigigas does not move.\pIts hide turns your blow aside like weather."),
    [STRINGID_ENCREGIGIGASRUNG1]           = COMPOUND_STRING("Something behind Regigigas' eyes has begun to move."),
    [STRINGID_ENCREGIGIGASRUNG2]           = COMPOUND_STRING("The floor shakes.\pRegigigas is pulling itself upright."),
    [STRINGID_ENCREGIGIGASRUNG3]           = COMPOUND_STRING("Regigigas is awake.\pIts hide no longer shrugs you off the way it did.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCREGIGIGASRUNG4]           = COMPOUND_STRING("Regigigas remembers what it was built to do."),
    ...
    [STRINGID_ENCREGIGIGASREMEMBERSGRIP]   = COMPOUND_STRING("Regigigas remembers how to close its hands."),
    ...
    [STRINGID_ENCREGIGIGASKNITS]           = COMPOUND_STRING("Its wounds knit closed in the stillness."),
    [STRINGID_ENCREGIGIGASGRUDGESETUP]     = COMPOUND_STRING("Regigigas remembers how you grew."),
    [STRINGID_ENCREGIGIGASGRUDGESWITCH]    = COMPOUND_STRING("Regigigas remembers the one that ran."),
    [STRINGID_ENCREGIGIGASGRUDGESTATUS]    = COMPOUND_STRING("Regigigas remembers the poison in its joints."),
    [STRINGID_ENCREGIGIGASCRUSHESBOOSTS]   = COMPOUND_STRING("Regigigas shakes the ground out from under you!"),
    [STRINGID_ENCREGIGIGASTITANMOVES]      = COMPOUND_STRING("Regigigas sets one hand on the floor and stands.\pTHE TITAN MOVES.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCREGIGIGASTEARSSCREENS]    = COMPOUND_STRING("The air you were hiding behind tears apart."),
    [STRINGID_ENCREGIGIGASFULLAWAKENING]   = COMPOUND_STRING("Regigigas' seals give way all at once.\pFULL AWAKENING.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCREGIGIGASWEAKENED]        = COMPOUND_STRING("The titan sinks back to one knee, and does not rise.\pNow - now is the moment to catch it!{PAUSE_UNTIL_PRESS}"),
    ...
    [STRINGID_ENCREGIGIGASFORCEREELING]    = COMPOUND_STRING("Regigigas' own strength has left it reeling."),
    [STRINGID_ENCREGIGIGASSLOWING]         = COMPOUND_STRING("Regigigas' movements are slowing."),
    [STRINGID_ENCREGIGIGASFALTERING]       = COMPOUND_STRING("Regigigas' breathing has turned ragged."),
    [STRINGID_ENCREGIGIGASCOLLAPSE]        = COMPOUND_STRING("Regigigas' colossal body finally gives out beneath it!{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCREGIGIGASSTILLDOWN]       = COMPOUND_STRING("Regigigas' body still will not answer it."),
    [STRINGID_ENCREGIGIGASUPRIGHT]         = COMPOUND_STRING("Regigigas hauls itself upright."),

    [STRINGID_ENCROTOMINTRO1]           = COMPOUND_STRING("The appliance in the corner comes on by itself.\pIts screen fills with a face.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCROTOMINTRO2]           = COMPOUND_STRING("Rotom is running something it was not built to run."),
    [STRINGID_ENCROTOMPROTOCOLHEAT]     = COMPOUND_STRING("OVERHEAT PROTOCOL.\pThe element glows white, and stays glowing."),
    [STRINGID_ENCROTOMPROTOCOLWASH]     = COMPOUND_STRING("FLOOD PROTOCOL.\pThe drum starts to spin."),
    [STRINGID_ENCROTOMPROTOCOLFROST]    = COMPOUND_STRING("CRYO PROTOCOL.\pThe air in front of the vents goes white."),
    ...
    [STRINGID_ENCROTOMFLUSH]            = COMPOUND_STRING("The old machine powers down, and takes everything on it with it."),
    [STRINGID_ENCROTOMWASHSCOURS]       = COMPOUND_STRING("The flood scours the field bare."),
    [STRINGID_ENCROTOMWASHREGEN]        = COMPOUND_STRING("Coolant runs through Rotom, and the damage goes quiet."),
    [STRINGID_ENCROTOMFANSTRIKE]        = COMPOUND_STRING("Rotom is already moving when you look up!"),
    [STRINGID_ENCROTOMOVERCLOCK1]       = COMPOUND_STRING("Something in Rotom starts to hum."),
    [STRINGID_ENCROTOMOVERCLOCK2]       = COMPOUND_STRING("The hum climbs a note."),
    [STRINGID_ENCROTOMOVERCLOCK3]       = COMPOUND_STRING("Rotom is running past what the casing was rated for."),
    [STRINGID_ENCROTOMOVERCLOCK4]       = COMPOUND_STRING("The casing has begun to blister."),
    [STRINGID_ENCROTOMOVERCLOCK5]       = COMPOUND_STRING("EVERYTHING IN ROTOM IS SCREAMING.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCROTOMHARDENS]          = COMPOUND_STRING("Rotom pulls the heat inward and sets it against you.\pYour attacks are barely reaching it now.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCROTOMSTRAINING]        = COMPOUND_STRING("Rotom is holding itself together, and holding you off with it."),
    [STRINGID_ENCROTOMFEDTHEMOTOR]      = COMPOUND_STRING("The current pours into Rotom and the motor takes it."),
    [STRINGID_ENCROTOMSYSTEMOVERLOAD]   = COMPOUND_STRING("SYSTEM OVERLOAD!\pRotom is thrown out of the machine, and lands with nothing left running.{PAUSE_UNTIL_PRESS}"),
    ...
    [STRINGID_ENCROTOMSTILLDOWN]        = COMPOUND_STRING("Rotom is still trying to bring itself back up."),
    [STRINGID_ENCROTOMREBOOT]           = COMPOUND_STRING("Rotom finds a socket and slides back in."),
    [STRINGID_ENCROTOMHIJACKCONTROL]    = COMPOUND_STRING("Rotom reaches into your controls.\p{B_BUFF1} no longer answers!"),
    [STRINGID_ENCROTOMHIJACKPOWER]      = COMPOUND_STRING("Rotom cuts the power to the item your Pokémon was holding!"),
    [STRINGID_ENCROTOMHIJACKFIELDFIRE]  = COMPOUND_STRING("Rotom vents the burners across your side of the field!"),
    [STRINGID_ENCROTOMHIJACKFIELDSWAMP] = COMPOUND_STRING("Rotom floods your side of the field and leaves it thick!"),
    [STRINGID_ENCROTOMROGUEPROGRAM]     = COMPOUND_STRING("Rotom stops pretending to be an appliance.\pROGUE PROGRAM.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCROTOMTEARSSCREENS]     = COMPOUND_STRING("The field you were hiding behind is wiped."),
    [STRINGID_ENCROTOMTAKEOVER]         = COMPOUND_STRING("Every machine in the room turns to face you at once.\pTOTAL SYSTEM TAKEOVER.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCROTOMWEAKENED]         = COMPOUND_STRING("Rotom flickers, and cannot hold a shape any more.\pNow - now is the moment to catch it!{PAUSE_UNTIL_PRESS}"),

    [STRINGID_ENCSHAYMININTRO1]           = COMPOUND_STRING("The clearing is deep in gracidea, and every flower in it has turned to face you.\pSomething in the middle of them lifts its head.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCSHAYMININTRO2]           = COMPOUND_STRING("Shaymin does not step back."),
    [STRINGID_ENCSHAYMINBLOOM3]           = COMPOUND_STRING("THE WHOLE CLEARING OPENS AT ONCE.\pShaymin stands in the middle of it with nothing held back, and nothing held up.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCSHAYMINBLOOM2]           = COMPOUND_STRING("The clearing is thick and green now, and the air over it has gone sweet.\pShaymin has stopped bracing.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCSHAYMINBLOOM1]           = COMPOUND_STRING("Shoots come up through the dirt where Shaymin is standing."),
    [STRINGID_ENCSHAYMINNEUTRAL]          = COMPOUND_STRING("The clearing goes quiet, and Shaymin watches you across it."),
    [STRINGID_ENCSHAYMINBLIGHT1]          = COMPOUND_STRING("The flowers nearest Shaymin have started to curl."),
    [STRINGID_ENCSHAYMINBLIGHT2]          = COMPOUND_STRING("The gracidea is going brown from the edges in.\pShaymin will not settle.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCSHAYMINBLIGHT3]          = COMPOUND_STRING("NOTHING IS LEFT GROWING HERE.\pShaymin turns on the bare ground, and the ground catches.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCSHAYMINSTANDINGBLOOM]    = COMPOUND_STRING("The clearing is still growing around Shaymin."),
    [STRINGID_ENCSHAYMINSTANDINGBLIGHT]   = COMPOUND_STRING("The clearing is still dying around Shaymin."),
    [STRINGID_ENCSHAYMINTOSKY]            = COMPOUND_STRING("Shaymin cannot stand on ground like this.\pIt folds itself into something built to leave.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCSHAYMINTOLAND]           = COMPOUND_STRING("Shaymin comes down, and lets the grass take its weight again."),
    [STRINGID_ENCSHAYMINGRATITUDE]        = COMPOUND_STRING("Shaymin looks at what the two of you have made of this clearing.\pIt is grateful.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCSHAYMINGRATITUDEGIFT]    = COMPOUND_STRING("The gratitude is not kept. It is handed back."),
    [STRINGID_ENCSHAYMININDIFFERENT]      = COMPOUND_STRING("Shaymin is still deciding what this battle is."),
    [STRINGID_ENCSHAYMINDISTRESS]         = COMPOUND_STRING("Shaymin cries out, and the sound does not stop where the clearing does."),
    [STRINGID_ENCSHAYMINDISTRESSFIELD]    = COMPOUND_STRING("The dead growth on your side of the field goes up!"),
    [STRINGID_ENCSHAYMINFLAREARRIVES]     = COMPOUND_STRING("Shaymin gathers in everything the clearing has left to give.\pSEED FLARE.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCSHAYMINFLARE]            = COMPOUND_STRING("Shaymin releases the flower on its back!"),
    [STRINGID_ENCSHAYMINFLAREBLOOM]       = COMPOUND_STRING("The burst passes over your Pokémon like weather, and closes over Shaymin's wounds."),
    [STRINGID_ENCSHAYMINFLAREBLIGHTSTRIP] = COMPOUND_STRING("Everything you had raised over your side is stripped away!"),
    [STRINGID_ENCSHAYMINFLAREBLIGHT]      = COMPOUND_STRING("The burst is all thorn and no bloom!"),
    [STRINGID_ENCSHAYMINWEAKENEDBLOOM]    = COMPOUND_STRING("Shaymin settles into the grass in front of you, and waits.\pNow - now is the moment to catch it!{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCSHAYMINWEAKENEDNEUTRAL]  = COMPOUND_STRING("Shaymin is spent, and watching you.\pNow - now is the moment to catch it!{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCSHAYMINWEAKENEDBLIGHT]   = COMPOUND_STRING("Shaymin will not come down, and it will not stop watching you.\pNow - now is the moment to catch it!{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCHEATRANINTRO1]           = COMPOUND_STRING("The heat comes off the stone in sheets, and the whole dome is breathing.\pHeatran is standing on the ceiling of it, upside down, watching you.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCHEATRANINTRO2]           = COMPOUND_STRING("The mountain is awake too."),
    [STRINGID_ENCHEATRANPRESSURE0]        = COMPOUND_STRING("The mountain settles, and the stone underfoot stops humming."),
    [STRINGID_ENCHEATRANPRESSURE1]        = COMPOUND_STRING("Something turns over far below, and the air over the dome goes dry."),
    [STRINGID_ENCHEATRANPRESSURE2]        = COMPOUND_STRING("The floor of the dome is glowing through its cracks."),
    [STRINGID_ENCHEATRANPRESSURE3]        = COMPOUND_STRING("THE BASIN IS RUNNING OVER.\pLava comes across the floor, and the light off it fills the whole dome.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCHEATRANPRESSURE4]        = COMPOUND_STRING("The mountain is boiling, and Heatran has stopped getting out of its way."),
    [STRINGID_ENCHEATRANPRESSURE5]        = COMPOUND_STRING("EVERYTHING GOES STILL.\pThe mountain draws breath.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCHEATRANSTANDING]         = COMPOUND_STRING("The lava is still moving across your side of the field."),
    [STRINGID_ENCHEATRANLAVAFLOW]         = COMPOUND_STRING("The flow comes down over your side of the field!"),
    [STRINGID_ENCHEATRANSCOURED]          = COMPOUND_STRING("It takes everything laid on the ground with it!"),
    [STRINGID_ENCHEATRANTHERMALSHOCK]     = COMPOUND_STRING("The rock around Heatran contracts with a crack, and settles harder than it was."),
    [STRINGID_ENCHEATRANSHOCKSTANDING]    = COMPOUND_STRING("Heatran's shell is still drawn tight."),
    [STRINGID_ENCHEATRANSHOCKENDS]        = COMPOUND_STRING("The stone over Heatran works itself loose again."),
    [STRINGID_ENCHEATRANCOOLWATER]        = COMPOUND_STRING("The water hits glowing rock and goes straight up as steam!"),
    [STRINGID_ENCHEATRANCOOLICE]          = COMPOUND_STRING("The cold rolls in low across the floor of the dome."),
    [STRINGID_ENCHEATRANSTOKED]           = COMPOUND_STRING("Heatran feeds its own fire back into the mountain!"),
    [STRINGID_ENCHEATRANWEATHERCOOL]      = COMPOUND_STRING("The sky over the dome is working against the heat."),
    [STRINGID_ENCHEATRANPLUGGED]          = COMPOUND_STRING("Heatran has gone still - and the heat has nowhere to go."),
    [STRINGID_ENCHEATRANPOCKETARMED]      = COMPOUND_STRING("The ground beneath {B_PLAYER_MON1_NAME} begins to glow!"),
    [STRINGID_ENCHEATRANPOCKETSTANDING]   = COMPOUND_STRING("The glow under {B_PLAYER_MON1_NAME} is getting brighter!"),
    [STRINGID_ENCHEATRANPOCKETBURST]      = COMPOUND_STRING("The ground opens under {B_PLAYER_MON1_NAME}!"),
    [STRINGID_ENCHEATRANPOCKETBLOCKED]    = COMPOUND_STRING("The burst breaks against {B_PLAYER_MON1_NAME}'s guard!"),
    [STRINGID_ENCHEATRANPOCKETSWITCHED]   = COMPOUND_STRING("The magma comes up through ground nobody is standing on."),
    [STRINGID_ENCHEATRANPOCKETCOOLED]     = COMPOUND_STRING("The glow under {B_PLAYER_MON1_NAME} dims, and goes out."),
    [STRINGID_ENCHEATRANFIELDBURN]        = COMPOUND_STRING("The heat coming up through the floor scalds your side!"),
    [STRINGID_ENCHEATRANGROUNDED]         = COMPOUND_STRING("{B_PLAYER_MON1_NAME} has nowhere to stand that is not burning!"),
    [STRINGID_ENCHEATRANCOREVENT]         = COMPOUND_STRING("THE DOME VENTS.\pEverything the mountain was holding comes out at once - and Heatran is in the middle of it.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCHEATRANVENTSTANDING]     = COMPOUND_STRING("Heatran is still shaking off the blast."),
    [STRINGID_ENCHEATRANVENTRECOVER]      = COMPOUND_STRING("Heatran plants itself again, and the heat begins to gather."),
    [STRINGID_ENCHEATRANMAGMACORE]        = COMPOUND_STRING("Heatran drops through the crust into the chamber under it.\pWhat climbs back out is burning from the inside.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCHEATRANMEGA]             = COMPOUND_STRING("Heatran has taken the mountain into itself.\pMEGA HEATRAN.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCHEATRANDRINKS]           = COMPOUND_STRING("Heatran is drinking from the flow."),
    [STRINGID_ENCHEATRANERUPTION]         = COMPOUND_STRING("THE ENTIRE MOUNTAIN BEGINS TO SHAKE!\pWhatever is coming, it is not going to wait for either of you.{PAUSE_UNTIL_PRESS}"),
    ...
    [STRINGID_ENCDIALGAINTRO1]            = COMPOUND_STRING("Dialga is not waiting for you. It is deciding when you arrived.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCDIALGAINTRO2]            = COMPOUND_STRING("The air ticks like something enormous keeping time."),
    [STRINGID_ENCDIALGAMARK]              = COMPOUND_STRING("Dialga has marked this moment in time."),
    [STRINGID_ENCDIALGASHED]              = COMPOUND_STRING("Dialga returns to the moment before it was harmed!"),
    [STRINGID_ENCDIALGAQUOTA0]            = COMPOUND_STRING("It gives you four turns, and asks for a wound it will remember."),
    [STRINGID_ENCDIALGAQUOTA1]            = COMPOUND_STRING("Four turns. It expects less of you than before."),
    [STRINGID_ENCDIALGAQUOTA2]            = COMPOUND_STRING("Three turns. The mark is set closer now."),
    [STRINGID_ENCDIALGAQUOTA3]            = COMPOUND_STRING("Three turns, and it has already decided how they end."),
    [STRINGID_ENCDIALGAQUOTA4]            = COMPOUND_STRING("Two turns. There is barely a moment to fill."),
    [STRINGID_ENCDIALGAQUOTA5]            = COMPOUND_STRING("Two turns. It is no longer really asking."),
    [STRINGID_ENCDIALGACOUNT3]            = COMPOUND_STRING("The moment is still far off."),
    [STRINGID_ENCDIALGACOUNT2]            = COMPOUND_STRING("Two turns remain before the mark."),
    [STRINGID_ENCDIALGACOUNT1]            = COMPOUND_STRING("One turn remains before the mark."),
    [STRINGID_ENCDIALGAHOLD]              = COMPOUND_STRING("THE TIMELINE HOLDS!\pDialga's grip on the moment slips."),
    [STRINGID_ENCDIALGASTAGGER]           = COMPOUND_STRING("Dialga is caught out of step with itself!"),
    ...
    [STRINGID_ENCDIALGAECHO]              = COMPOUND_STRING("A temporal echo tears out of the collapse!"),
    [STRINGID_ENCDIALGAECHOBLOCKED]       = COMPOUND_STRING("Most of it breaks against something {B_PLAYER_MON1_NAME} was already holding."),
    [STRINGID_ENCDIALGACHARGE0]           = COMPOUND_STRING("Time is running the way it should."),
    [STRINGID_ENCDIALGACHARGE1]           = COMPOUND_STRING("TEMPORAL CHARGE: TICKING.\pSomething has started counting."),
    [STRINGID_ENCDIALGACHARGE2]           = COMPOUND_STRING("TEMPORAL CHARGE: FLOWING.\pThe moments are running together."),
    [STRINGID_ENCDIALGACHARGE3]           = COMPOUND_STRING("TEMPORAL CHARGE: ACCELERATED.\pDialga is moving through a faster hour than you are."),
    [STRINGID_ENCDIALGACHARGE4]           = COMPOUND_STRING("TEMPORAL CHARGE: UNMOORED.\pYour turns are arriving before you have taken them."),
    [STRINGID_ENCDIALGACHARGE5]           = COMPOUND_STRING("TIME MASTERY.\pDialga owns every moment on this field.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCDIALGAACCEL1]            = COMPOUND_STRING("Dialga accelerates the flow of time!{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCDIALGAACCEL2]            = COMPOUND_STRING("Everything you set down begins to wear out."),
    [STRINGID_ENCDIALGAAGE]               = COMPOUND_STRING("Time accelerates around {B_PLAYER_MON1_NAME}!"),
    [STRINGID_ENCDIALGAAGEWEARS]          = COMPOUND_STRING("What you built here has already worn away."),
    [STRINGID_ENCDIALGAAGEDEEP]           = COMPOUND_STRING("{B_PLAYER_MON1_NAME} is fighting through years it has not lived."),
    [STRINGID_ENCDIALGAORIGIN1]           = COMPOUND_STRING("Dialga's temporal power reaches its peak!"),
    [STRINGID_ENCDIALGAORIGIN2]           = COMPOUND_STRING("ORIGIN FORME.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCDIALGAFRACTURE]          = COMPOUND_STRING("The future splits into countless possibilities..."),
    [STRINGID_ENCDIALGAFUTRECOIL]         = COMPOUND_STRING("In every future you can see, you strike first - and something strikes back.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCDIALGAFUTLOCK]           = COMPOUND_STRING("In every future you can see, you are running. Dialga closes them all.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCDIALGAFUTCLOSING]        = COMPOUND_STRING("In every future you can see, you are waiting. Dialga stops giving you the time.{PAUSE_UNTIL_PRESS}"),
    [STRINGID_ENCDIALGARECOIL]            = COMPOUND_STRING("The moment you struck comes back around!"),
    [STRINGID_ENCDIALGALOCK]              = COMPOUND_STRING("There is no longer a moment in which you leave."),
    [STRINGID_ENCDIALGACLOSING]           = COMPOUND_STRING("The hours you were counting on are already spent!"),
    [STRINGID_ENCDIALGACONV1]             = COMPOUND_STRING("The timelines begin collapsing into one!"),
    [STRINGID_ENCDIALGACONV2]             = COMPOUND_STRING("Only this moment is left - and Dialga is barely holding it.\pNow - now is the moment to catch it!{PAUSE_UNTIL_PRESS}"),
};
