...
#else
    u32 rnd = Random() + sSlotMachineRandomSeeds[gSpecialVar_0x8004];
...
static const u8 *const sScrollableMultichoiceOptions[][MAX_SCROLL_MULTI_LENGTH] =
{
    ...
    [SCROLL_MULTI_MAUVILLE_GAME_CORNER_TMS] =
    {
        ...
        COMPOUND_STRING("LONELY MINT{CLEAR_TO 78}3,000"),
        COMPOUND_STRING("ADAMANT MINT{CLEAR_TO 78}3,000"),
        COMPOUND_STRING("NAUGHTY MINT{CLEAR_TO 78}3,000"),
        COMPOUND_STRING("BRAVE MINT{CLEAR_TO 78}3,000"),
        COMPOUND_STRING("BOLD MINT{CLEAR_TO 78}3,000"),
        COMPOUND_STRING("IMPISH MINT{CLEAR_TO 78}3,000"),
        COMPOUND_STRING("LAX MINT{CLEAR_TO 78}3,000"),
        COMPOUND_STRING("RELAXED MINT{CLEAR_TO 78}3,000"),
        COMPOUND_STRING("MODEST MINT{CLEAR_TO 78}3,000"),
        COMPOUND_STRING("MILD MINT{CLEAR_TO 78}3,000"),
        COMPOUND_STRING("RASH MINT{CLEAR_TO 78}3,000"),
        COMPOUND_STRING("QUIET MINT{CLEAR_TO 78}3,000"),
        COMPOUND_STRING("CALM MINT{CLEAR_TO 78}3,000"),
        COMPOUND_STRING("GENTLE MINT{CLEAR_TO 78}3,000"),
        COMPOUND_STRING("CAREFUL MINT{CLEAR_TO 78}3,000"),
        COMPOUND_STRING("SASSY MINT{CLEAR_TO 78}3,000"),
        COMPOUND_STRING("TIMID MINT{CLEAR_TO 78}3,000"),
        COMPOUND_STRING("HASTY MINT{CLEAR_TO 78}3,000"),
        COMPOUND_STRING("JOLLY MINT{CLEAR_TO 78}3,000"),
        COMPOUND_STRING("NAIVE MINT{CLEAR_TO 78}3,000"),
        COMPOUND_STRING("SERIOUS MINT{CLEAR_TO 78}3,000"),
        gText_Exit,
    },
    [SCROLL_MULTI_MAUVILLE_GAME_CORNER_MONS] =
    {
        ...
        COMPOUND_STRING("TOXEL{CLEAR_TO 78}5,000"),
...
{
    GetSetPokedexFlagBySpecies(gSpecialVar_0x8004, FLAG_SET_SEEN);
}
...
static enum Species SampleResortGorgeousMon(void)
{
    ...
    for (i = 0; i < 100; i++)
    {
        ...
        if (GetSetPokedexFlagBySpecies(species, FLAG_GET_SEEN) == TRUE)
            return species;
    }
    while (GetSetPokedexFlagBySpecies(species, FLAG_GET_SEEN) != TRUE)
    {
