...
const u8 sCaughtBallPartial_Gfx[] = INCGFX_U8("graphics/pokedex/caught_ball_partial.png", ".4bpp");
...
void CreateCaughtBall(enum DexCaughtState owned, u8 x, u8 y, u16 unused)
{
    u32 xMultiplier = 8;
    if (POKEDEX_PLUS_HGSS)
        xMultiplier = 6;

    // Three states: every form caught, some forms caught, none.
    switch (owned)
    {
    case DEX_CAUGHT_ALL:
    ...
    case DEX_CAUGHT_PARTIAL:
        BlitBitmapToWindow(0, sCaughtBallPartial_Gfx, x * xMultiplier, y * 8, 8, 16);
        break;
    default:
