...
static bool8 WaterfallFieldEffect_WaitForIdle(struct Task *, struct ObjectEvent *);
...
static void SurfFieldEffect_WaitForIdle(struct Task *);
...
static bool8 (*const sWaterfallFieldEffectFuncs[])(struct Task *, struct ObjectEvent *) =
{
    ...
    WaterfallFieldEffect_WaitForIdle,
...
static bool8 WaterfallFieldEffect_WaitForIdle(struct Task *task, struct ObjectEvent *objectEvent)
{
    LockPlayerFieldControls();
...
{
    CreateTask(Task_SurfFieldEffect, 0xff);
...
static void SurfFieldEffect_WaitForIdle(struct Task *task)
{
    struct ObjectEvent *objectEvent = &gObjectEvents[gPlayerAvatar.objectEventId];
