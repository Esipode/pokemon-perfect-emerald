...
const u32 gHealthboxSinglesPlayerNoBarGfx[] = INCGFX_U32("graphics/battle_interface/healthbox_singles_player_no_bar.png", ".4bpp.smol", "-mwidth 8 -mheight 8");
const u32 gHealthboxSinglesOpponentNoBarGfx[] = INCGFX_U32("graphics/battle_interface/healthbox_singles_opponent_no_bar.png", ".4bpp.smol", "-mwidth 8 -mheight 4");
const u32 gHealthboxSinglesOpponentLargeNoBarGfx[] = INCGFX_U32("graphics/battle_interface/healthbox_singles_opponent_large_no_bar.png", ".4bpp.smol", "-mwidth 8 -mheight 8");
...
// Condition screen (Pokéblock)

const u16 gConditionCancel_Pal[] = INCGFX_U16("graphics/condition/cancel.pal", ".gbapal");
const u8 gConditionCancel_Gfx[] = INCGFX_U8("graphics/condition/cancel.png", ".4bpp");
