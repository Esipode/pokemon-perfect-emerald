...
const u8 gText_DexKantoTitle[] = _("KANTO");
const u8 gText_DexJohtoTitle[] = _("JOHTO");
const u8 gText_DexHoennTitle[] = _("HOENN");
const u8 gText_DexSinnohTitle[] = _("SINNOH");
const u8 gText_DexUnovaTitle[] = _("UNOVA");
const u8 gText_DexKalosTitle[] = _("KALOS");
const u8 gText_DexAlolaTitle[] = _("ALOLA");
const u8 gText_DexGalarTitle[] = _("GALAR");
const u8 gText_DexPaldeaTitle[] = _("PALDEA");
const u8 gText_DexNatDescription[] = _("National edition POKéDEX");
const u8 gText_DexKantoDescription[] = _("POKéMON first found in the\nKANTO region.");
const u8 gText_DexJohtoDescription[] = _("POKéMON first found in the\nJOHTO region.");
const u8 gText_DexHoennDescription[] = _("POKéMON first found in the\nHOENN region.");
const u8 gText_DexSinnohDescription[] = _("POKéMON first found in the\nSINNOH region.");
const u8 gText_DexUnovaDescription[] = _("POKéMON first found in the\nUNOVA region.");
const u8 gText_DexKalosDescription[] = _("POKéMON first found in the\nKALOS region.");
const u8 gText_DexAlolaDescription[] = _("POKéMON first found in the\nALOLA region.");
const u8 gText_DexGalarDescription[] = _("POKéMON first found in the\nGALAR region.");
const u8 gText_DexPaldeaDescription[] = _("POKéMON first found in the\nPALDEA region.");
...
const u8 gText_HereYouGoItemSentToPC[] = _("Here you go!\nYour BAG is full, so I sent\lthe item to your PC.");
...
const u8 gText_AchievementsEarned[] = _("ACHIEVEMENTS");
const u8 gText_AchievementPoints[] = _("ACHIEVEMENT POINTS");
const u8 gText_TrainerBattles[] = _("TRAINER BATTLES");
const u8 gText_ShiniesFound[] = _("SHINIES FOUND");
const u8 gText_BestWinStreak[] = _("BEST WIN STREAK");
const u8 gText_RunsCleared[] = _("RUNS CLEARED");
const u8 gText_AchievementFraction[] = _("{STR_VAR_1}/{STR_VAR_2}");
const u8 gText_RunsClearedValue[] = _("N:{COLOR RED}{SHADOW LIGHT_RED}{STR_VAR_1}{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}  R:{COLOR RED}{SHADOW LIGHT_RED}{STR_VAR_2}{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}  G+:{COLOR RED}{SHADOW LIGHT_RED}{STR_VAR_3}{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}");
...
const u8 gText_NewGamePlusConfirm[] = _("This will place you back at the beginning\nof the game.\pYou will keep your Pokémon.\nYou will then begin a new playthrough\pwith a much higher level cap.{PAUSE_UNTIL_PRESS}");
const u8 gText_NewGamePlusAreYouSure[] = _("Are you sure you want to do this?");
