...
const u8 gText_AIBattles[] = _("AI BATTLES");
const u8 gText_AIBattlesTrainer[] = _("AI BATTLE - TRNR");
const u8 gText_AIBattlesWild[] = _("AI BATTLE - WILD");
const u8 gText_AutoScroll[] = _("AUTO SCROLL");
const u8 gText_Randomizer[] = _("RANDOMIZER");
const u8 gText_SpeciesRandomizer[] = _("RANDOMIZE MONS");
...
const u8 gText_AIBattlesOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_AIBattlesOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_AutoScrollOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_AutoScrollOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_RandomizerOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_RandomizerOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_TypeRandomizerOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_TypeRandomizerOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_MovesRandomizerOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_MovesRandomizerOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
...
const u8 gText_NuzlockeOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_NuzlockeOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_AutosaveOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_AutosaveOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_AllowStatEditor[] = _("ALLOW STAT EDIT");
const u8 gText_AllowStatEditorOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_AllowStatEditorOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
