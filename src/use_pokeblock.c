...
static const u16 sConditionGraphData_Pal[] = INCGFX_U16("graphics/condition/graph_data.pal", ".gbapal");
static const u16 sConditionText_Pal[] = INCGFX_U16("graphics/condition/text.pal", ".gbapal");
