...
static void Task_OptionMenuProcessInput_Pg2(u8 taskId)
{
    ...
    else
    {
        ...
        case MENUITEM_NUZLOCKE:
            ...
            if (previousOption != gTasks[taskId].tNuzlocke)
                Nuzlocke_DrawChoices(gTasks[taskId].tNuzlocke);
            break;
...
static void Task_OptionMenuProcessInput_Pg3(u8 taskId)
{
    ...
    else
    {
        ...
        case MENUITEM_ALLOW_STAT_EDITOR:
            previousOption = gTasks[taskId].tStatEditor;
            gTasks[taskId].tStatEditor = StatEditor_ProcessInput(gTasks[taskId].tStatEditor);
