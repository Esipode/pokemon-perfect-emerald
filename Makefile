...
ENCOUNTERPROC := $(TOOLS_DIR)/encounterproc/encounterproc$(EXE)
...
AUTO_GEN_TARGETS += $(DATA_SRC_SUBDIR)/pokemon/national_dex_num_to_species.h
AUTO_GEN_TARGETS += $(DATA_SRC_SUBDIR)/pokemon/legendary_families.h
...
$(DATA_SRC_SUBDIR)/pokemon/national_dex_num_to_species.h: $(MISC_TOOL_DIR)/make_natdex_species_table.py $(INCLUDE_DIRS)/constants/species.h $(wildcard $(DATA_SRC_SUBDIR)/pokemon/species_info/gen_*_families.h)
	python3 $(MISC_TOOL_DIR)/make_natdex_species_table.py

$(DATA_SRC_SUBDIR)/pokemon/legendary_families.h: $(MISC_TOOL_DIR)/make_legendary_family_table.py $(DATA_SRC_SUBDIR)/pokemon/form_species_tables.h $(wildcard $(DATA_SRC_SUBDIR)/pokemon/species_info/gen_*_families.h)
	python3 $(MISC_TOOL_DIR)/make_legendary_family_table.py
