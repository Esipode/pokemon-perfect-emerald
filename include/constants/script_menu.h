...
#define STARTER_GEN_OPTIONS                115
#define CHAMPION_CHALLENGE_CHOICE_PAGE1    116
#define CHAMPION_CHALLENGE_CHOICE_PAGE2    117
#define CHAMPION_CHALLENGE_CHOICE_PAGE3    118
