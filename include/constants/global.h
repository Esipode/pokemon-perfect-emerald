...
#define MAIL_COUNT (2 + PARTY_SIZE) // ORIGINALLY (10 + PARTY_SIZE)
#define SECRET_BASES_COUNT 1 // ORIGINALLY 20
#define POKE_NEWS_COUNT 4 // ORIGINALLY 16
#define PC_ITEMS_COUNT 30 // ORIGINALLY 50
...
#define ROAMER_COUNT 1 // Only one roamer is ever active; the next one is picked from gRoamableSpecies (src/roamer.c) by scanning the player's party/storage for a species they don't currently have
...
#define OPTIONS_BATTLE_SPEED_1_5X 1
#define OPTIONS_BATTLE_SPEED_2X 2
#define OPTIONS_BATTLE_SPEED_3X 3
#define OPTIONS_BATTLE_SPEED_4X 4
