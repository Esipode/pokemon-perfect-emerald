...
extern const u8 gText_AIBattlesOff[];
extern const u8 gText_AIBattlesOn[];
...
extern const u8 gText_TypeRandomizerOff[];
extern const u8 gText_TypeRandomizerOn[];
extern const u8 gText_MovesRandomizerOff[];
extern const u8 gText_MovesRandomizerOn[];
extern const u8 gText_LevelCapOn[];
extern const u8 gText_LevelCapOff[];
extern const u8 gText_NuzlockeOff[];
