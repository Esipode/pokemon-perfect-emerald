...
// See Customization.md, Stage 3. Full-screen menu for picking the player's
// Hair/Hat/Outfit/Accent hue and shade. Reads/writes gSaveBlock2Ptr->
// playerColors (through Stage 1's src/player_customization.c) and reads
// gSaveBlock2Ptr->playerGender to pick which region table and avatar
