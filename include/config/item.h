...
// Exp. Share config
// Whether the whole party gains exp is a SaveBlock2 option (gSaveBlock2Ptr->optionsExpShare,
// toggleable in the options menu, on by default), not a flag.
...
// Vs. Seeker
#define I_VS_SEEKER_CHARGING        0                     // If this flag is assigned, the Vs. Seeker functionality will be enabled. Documentation for the Vs. Seeker can be found in docs/tutorials/vs_seeker.md.
#define I_SHOW_NO_ID_TRAINER        DISABLED_ON_RELEASE   // If TRUE, object events with a trainer type but no visible trainer id will be shown with a question mark.
