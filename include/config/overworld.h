...
#define OW_FLAG_POKE_RIDER          0  // If this flag is set, the player will be able to use fly from the Region Map and the Town Map key item by pressing 'R' on a city/location they are able to fly to.
